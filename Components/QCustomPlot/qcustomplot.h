...
protected:
    ...
    virtual void legendRemoved(QCPLegend *legend_ptr);
...
protected:
    ...
    // non-virtual methods:
    QLineF getRectClippedLine(const QCPVector2D &start_vector, const QCPVector2D &end_vector, const QRect &rect) const;
    QPen mainPen() const;
};
