...
const size_t    MD5_RESULT_SIZE = MD5_SIZE * 2;
const char      HEX_CHARS[] = "0123456789ABCDEF";
const size_t    SHA256_SIZE = 32;
const size_t    SHA256_RESULT_SIZE = SHA256_SIZE * 2;
...
const char              LOG_PIPE_NAME[] = "\\\\.\\pipe\\Carat"; //Имя именованного канала
const size_t            LOG_PIPE_TIMEOUT = 5000; //Время ожидания реализации канала
const unsigned short    LOG_UDP_PORT = 50001; //Стандартный UDP-порт для логгера
const size_t            LOG_UDP_BUFFER_SIZE = 2;
...
const char API_BLOCKED_IP_ADD[] = "BlockedIPAdd"; //Добавить адрес в блокировку
//PROTOCOL---------------------------------------------------------------------
