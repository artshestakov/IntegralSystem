...
//-----------------------------------------------------------------------------
ISAes256::ISAes256(const std::vector<unsigned char> &key)
...
//-----------------------------------------------------------------------------
size_t ISAes256::encrypt(const std::vector<unsigned char> &key, const std::vector<unsigned char> &plain, std::vector<unsigned char> &encrypted)
{
	ISAes256 aes(key);
...
//-----------------------------------------------------------------------------
size_t ISAes256::encrypt(const std::vector<unsigned char> &key, const unsigned char *plain, const size_t plain_length, std::vector<unsigned char> &encrypted)
{
	ISAes256 aes(key);
...
//-----------------------------------------------------------------------------
size_t ISAes256::decrypt(const std::vector<unsigned char> &key, const std::vector<unsigned char> &encrypted, std::vector<unsigned char> &plain)
{
	ISAes256 aes(key);
...
//-----------------------------------------------------------------------------
size_t ISAes256::decrypt(const std::vector<unsigned char> &key, const unsigned char *encrypted, const size_t encrypted_length, std::vector<unsigned char> &plain)
{
	ISAes256 aes(key);
...
//-----------------------------------------------------------------------------
size_t ISAes256::encrypt_start(const size_t plain_length, std::vector<unsigned char> &encrypted)
{
...
//-----------------------------------------------------------------------------
size_t ISAes256::encrypt_continue(const std::vector<unsigned char> &plain, std::vector<unsigned char> &encrypted)
{
...
//-----------------------------------------------------------------------------
size_t ISAes256::encrypt_continue(const unsigned char *plain, const size_t plain_length, std::vector<unsigned char> &encrypted)
{
	size_t i = 0;
...
//-----------------------------------------------------------------------------
void ISAes256::check_and_encrypt_buffer(std::vector<unsigned char> &encrypted)
{
...
//-----------------------------------------------------------------------------
size_t ISAes256::encrypt_end(std::vector<unsigned char> &encrypted)
{
	if (m_buffer_pos > 0)
	{
...
//-----------------------------------------------------------------------------
void ISAes256::encrypt(unsigned char* buffer)
{
...
//-----------------------------------------------------------------------------
size_t ISAes256::decrypt_start(const size_t encrypted_length)
{
...
//-----------------------------------------------------------------------------
size_t ISAes256::decrypt_continue(const std::vector<unsigned char> &encrypted, std::vector<unsigned char> &plain)
{
...
//-----------------------------------------------------------------------------
size_t ISAes256::decrypt_continue(const unsigned char *encrypted, const size_t encrypted_length, std::vector<unsigned char> &plain)
{
	size_t i = 0;
...
//-----------------------------------------------------------------------------
void ISAes256::check_and_decrypt_buffer(std::vector<unsigned char> &plain)
{
...
//-----------------------------------------------------------------------------
size_t ISAes256::decrypt_end(std::vector<unsigned char> &plain)
{
	return plain.size();
}
//-----------------------------------------------------------------------------
void ISAes256::decrypt(unsigned char* buffer)
{
...
//-----------------------------------------------------------------------------
void ISAes256::expand_enc_key(unsigned char* rc)
{
...
//-----------------------------------------------------------------------------
void ISAes256::expand_dec_key(unsigned char* rc)
{
	unsigned char i;
	for (i = 28; i > 16; i -= 4)
	{
...
//-----------------------------------------------------------------------------
void ISAes256::sub_bytes(unsigned char* buffer)
{
...
//-----------------------------------------------------------------------------
void ISAes256::sub_bytes_inv(unsigned char* buffer)
{
	register unsigned char i = KEY_SIZE / 2;
	while (i--)
	{
...
//-----------------------------------------------------------------------------
void ISAes256::add_round_key(unsigned char* buffer, const unsigned char round)
{
	register unsigned char i = KEY_SIZE / 2;
	while (i--)
	{
...
//-----------------------------------------------------------------------------
void ISAes256::shift_rows(unsigned char* buffer)
{
...
//-----------------------------------------------------------------------------
void ISAes256::shift_rows_inv(unsigned char* buffer)
{
	register unsigned char i, j, k, l;
...
//-----------------------------------------------------------------------------
void ISAes256::mix_columns(unsigned char* buffer)
{
...
//-----------------------------------------------------------------------------
void ISAes256::mix_columns_inv(unsigned char* buffer)
{
