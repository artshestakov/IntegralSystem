...
//DATE_TIME_FORMATS------------------------------------------------------------
const char FORMAT_DATE_V1[] = "d MMMM yyyy"; //Формат даты: 30 Июль 2020
const char FORMAT_DATE_V2[] = "dd.MM.yyyy"; //Формат даты: 30.07.2020
const char FORMAT_DATE_V3[] = "dd/MM/yyyy"; //Формат даты: 30/07/2020
const char FORMAT_DATE_V4[] = "d MMMM yyyy (ddd)"; //Формат даты: 30 Июль 2020 (Чт)
const char FORMAT_TIME_V1[] = "hh:mm"; //Формат времени: 10:16
const char FORMAT_TIME_V2[] = "hh.mm"; //Формат времени: 10.16
...
//-----------------------------------------------------------------------------
const char CONST_UID_TASK_STATUS_NEW[] = "{2FD27958-6EC9-4E78-88F4-0A2BFDFE4716}";
...
const char CONST_UID_TASK_STATUS_CLOSED[] = "{38663444-57E0-451C-8C46-65DA507BDD9C}";
//-----------------------------------------------------------------------------
