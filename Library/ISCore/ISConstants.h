...
const char API_USER_DEVICE_ADD[] = "UserDeviceAdd"; //Привязка устройства к учётной записи пользователя
const char API_USER_DEVICE_DELETE[] = "UserDeviceDelete"; //Отвязка устройства от учётной записи пользователя
...
const char API_GET_STATEMENT[] = "GetStatement"; //Получить статистику запросов
...
const char CONST_UID_PROTOCOL_USER_DEVICE_DELETE[] = "{1450D20D-2401-4DF6-8689-51F962604D5B}";
