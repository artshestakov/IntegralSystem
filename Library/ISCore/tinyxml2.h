...
namespace tinyxml2
{
	...
	/*
		...
		Isn't clear why ISCORE_EXPORT is needed; but seems to fix #719
	*/
	class ISCORE_EXPORT StrPair
	{
	public:
		enum Mode {
	...
	*/
	...
	/**
		...
		@sa XMLNode::Accept()
	*/
	class ISCORE_EXPORT XMLVisitor
	{
	public:
		virtual ~XMLVisitor() {}
	...
	*/
	class ISCORE_EXPORT XMLText : public XMLNode
	{
		friend class XMLDocument;
	public:
	...
	/** An XML Comment. */
	class ISCORE_EXPORT XMLComment : public XMLNode
	{
		friend class XMLDocument;
	public:
		virtual XMLComment*	ToComment() {
	...
	*/
	class ISCORE_EXPORT XMLDeclaration : public XMLNode
	{
		friend class XMLDocument;
	public:
		virtual XMLDeclaration*	ToDeclaration() {
	...
	*/
	class ISCORE_EXPORT XMLUnknown : public XMLNode
	{
		friend class XMLDocument;
	public:
		virtual XMLUnknown*	ToUnknown() {
	...
	*/
	class ISCORE_EXPORT XMLAttribute
	{
		friend class XMLElement;
	public:
	...
	*/
	class ISCORE_EXPORT XMLElement : public XMLNode
	{
		friend class XMLDocument;
	public:
	...
	*/
	class ISCORE_EXPORT XMLDocument : public XMLNode
	{
		friend class XMLElement;
	...
	*/
	class ISCORE_EXPORT XMLConstHandle
	{
	public:
	...
	/**
		...
		@endverbatim
	*/
	class ISCORE_EXPORT XMLPrinter : public XMLVisitor
	{
	public:
