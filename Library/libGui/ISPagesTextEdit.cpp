...
ISPagesTextEdit::ISPagesTextEdit(QWidget *parent) :	QTextEdit(parent), m_document(0), m_usePageMode(false), m_addBottomSpace(true),	m_showPageNumbers(true), m_pageNumbersAlignment(Qt::AlignTop | Qt::AlignRight)
{
	...
	connect(this, &QTextEdit::textChanged, this, &ISPagesTextEdit::aboutDocumentChanged);

	//
	// Ручная настройка интервала прокрутки
	//
	connect(verticalScrollBar(), &QScrollBar::rangeChanged, this, &ISPagesTextEdit::aboutVerticalScrollRangeChanged);
}
//-----------------------------------------------------------------------------
void ISPagesTextEdit::setPageFormat(QPageSize::PageSizeId _pageFormat)
{
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::setPageMargins(const QMarginsF& _margins)
{
...
//-----------------------------------------------------------------------------
bool ISPagesTextEdit::usePageMode() const
{
	return m_usePageMode;
}
//-----------------------------------------------------------------------------
void ISPagesTextEdit::setUsePageMode(bool _use)
{
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::setAddSpaceToBottom(bool _addSpace)
{
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::setShowPageNumbers(bool _show)
{
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::setPageNumbersAlignment(Qt::Alignment _align)
{
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::paintEvent(QPaintEvent* _event)
{
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::resizeEvent(QResizeEvent* _event)
{
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::updateViewportMargins()
{
	//
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::updateVerticalScrollRange()
{
	//
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::paintPagesView()
{
	//
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::paintPageNumbers()
{
	//
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::paintPageNumber(QPainter* _painter, const QRectF& _rect, bool _isHeader, int _number)
{
	//
	// Верхнее поле
	//
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::aboutVerticalScrollRangeChanged(int _minimum, int _maximum)
{
	Q_UNUSED(_minimum);
...
//-----------------------------------------------------------------------------
void ISPagesTextEdit::aboutDocumentChanged()
{
	if (m_document != document()) {
		...
		//
		connect(document()->documentLayout(), &QAbstractTextDocumentLayout::update, this, &ISPagesTextEdit::aboutUpdateDocumentGeometry);
	}
}
//-----------------------------------------------------------------------------
void ISPagesTextEdit::aboutUpdateDocumentGeometry()
{
	//
