...
ISPhoneForm::ISPhoneForm(QWidget *parent) : ISInterfaceForm(parent)
{
	...
	CreateButton(1, 0, 0, "1", "PhoneButton_1");
	CreateButton(2, 0, 1, "2", "PhoneButton_2");
	CreateButton(3, 0, 2, "3", "PhoneButton_3");
	CreateButton(4, 1, 0, "4", "PhoneButton_4");
	CreateButton(5, 1, 1, "5", "PhoneButton_5");
	CreateButton(6, 1, 2, "6", "PhoneButton_6");
	CreateButton(7, 2, 0, "7", "PhoneButton_7");
	CreateButton(8, 2, 1, "8", "PhoneButton_8");
	CreateButton(9, 2, 2, "9", "PhoneButton_9");
	CreateButton(-1, 3, 0, "*", "PhoneButton_Star");
	CreateButton(0, 3, 1, "0", "PhoneButton_0");
