...
ISCalculatorForm::ISCalculatorForm(QWidget *parent) : ISInterfaceForm(parent)
{
	...
	ISCalculatorButton *DivisionButton = CreateButton(ISDefines::Core::SYMBOL_DIVIDE, &ISCalculatorForm::MultiplicativeOperatorClicked);
	ISCalculatorButton *TimesButton = CreateButton(ISDefines::Core::SYMBOL_MULTIPLY, &ISCalculatorForm::MultiplicativeOperatorClicked);
