	...
	for (int i = 0; i < ListWidget->count(); ++i)
	{
		...
		if (qSelect.ExecuteFirst())
		{
			...
			if (Count)
			{
				...
				qUpdate.BindValue(":Icon", ISGui::PixmapToByteArray(Icon.pixmap(ISDefines::Gui::SIZE_32_32)));
			...
			else
			{
				...
				qInsert.BindValue(":Icon", ISGui::PixmapToByteArray(Icon.pixmap(ISDefines::Gui::SIZE_32_32)));
