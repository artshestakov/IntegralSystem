...
bool ISExportDBF::Prepare()
{
	...
	QSqlDatabase Database = QSqlDatabase::addDatabase(SQL_DRIVER_QODBC, ConnectionName);
...
//-----------------------------------------------------------------------------
ISExportSQLite::~ISExportSQLite()
{

}
//-----------------------------------------------------------------------------
bool ISExportSQLite::Prepare()
{
	QString FilePath = ISFileDialog::GetSaveFileName(nullptr, LANG("File.Filter.SQLite"), MetaTable->LocalListName);
	if (FilePath.isEmpty())
	{
		return false;
	}
	...
	QSqlDatabase Database = QSqlDatabase::addDatabase(SQL_DRIVER_QSQLITE, ConnectionName);
