...
private:
	...
	QWidget* CommentCreateWidget(bool IsParent, int CommentID, int UserOID, const QPixmap &UserPhoto, const QString &UserFIO, const QString &Comment, const QDateTime &CreationDate, const QDateTime &UpdationDate);
	void CommentAdd();
	void CommentEdit();
	void CommentDelete();
