...
//-----------------------------------------------------------------------------
qreal ISPageMetrics::mmToPx(qreal _mm, bool _x)
{
	return ::mmToInches(_mm) * (_x ? qApp->desktop()->logicalDpiX() : qApp->desktop()->logicalDpiY());
}
//-----------------------------------------------------------------------------
QPageSize::PageSizeId ISPageMetrics::pageSizeIdFromString(const QString& _from)
{
...
//-----------------------------------------------------------------------------
QString ISPageMetrics::stringFromPageSizeId(QPageSize::PageSizeId _pageSize)
{
	QString result;
...
//-----------------------------------------------------------------------------
ISPageMetrics::ISPageMetrics(QPageSize::PageSizeId _pageFormat, QMarginsF _mmPageMargins)
{
	update(_pageFormat, _mmPageMargins);
}
//-----------------------------------------------------------------------------
void ISPageMetrics::update(QPageSize::PageSizeId _pageFormat, QMarginsF _mmPageMargins)
{
...
//-----------------------------------------------------------------------------
QPageSize::PageSizeId ISPageMetrics::pageFormat() const
{
	return m_pageFormat;
}
//-----------------------------------------------------------------------------
QSizeF ISPageMetrics::mmPageSize() const
{
	return m_mmPageSize;
}
//-----------------------------------------------------------------------------
QMarginsF ISPageMetrics::mmPageMargins() const
{
	return m_mmPageMargins;
}
//-----------------------------------------------------------------------------
QSizeF ISPageMetrics::pxPageSize() const
{
	return QSizeF(m_pxPageSize.width(),
				  m_pxPageSize.height());
}
//-----------------------------------------------------------------------------
QMarginsF ISPageMetrics::pxPageMargins() const
{
