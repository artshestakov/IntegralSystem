export INTEGRAL_SYSTEM_DIR="/home/artem/Solution"
export QT_DIR="/home/artem/Qt"
export QT_DIR_BIN="$QT_DIR/5.8/gcc_64/bin"
export QT_DIR_LIB="$QT_DIR/5.8/gcc_64/lib"
export QT_DIR_PLUGINS="$QT_DIR/5.8/gcc_64/plugins"
...
./BuildLibrary.sh ISSystem $1
./BuildLibrary.sh ISResources $1
./BuildLibrary.sh ISNetwork $1
./BuildLibrary.sh ISCore $1
./BuildLibrary.sh ISConfigurator $1
...
./BuildProject.sh DatabaseService $1

./BuildProject.sh EMailSender $1
...
#Сборка RPM-пакета
QA_RPATHS=0x0001 rpmbuild -bb IntegralSystem.spec --define "Configuration $1" --define "Version $MAJOR.$MINOR.$REVISION.$BUILD"
